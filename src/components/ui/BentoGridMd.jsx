...
const BentoGridMd = () => {
  return (
    <div className=" h-[25%] grid grid-cols-6 grid-rows-10 gap-3 mt-[100px]">
        ...
        <div className=" flex items-center justify-center relative group overflow-hidden  col-span-4 row-span-7 rounded-xl">
           {/** Overlay */}
        ...
        <div className=" flex items-center justify-center relative group overflow-hidden  rounded-xl col-span-2 row-span-4 ">
         ...
         <div className="relative group col-span-4 row-span-5 rounded-xl overflow-hidden flex items-center justify-center">
           {/** Overlay */}
           <div className="absolute inset-0 w-full h-full opacity-0 group-hover:opacity-60 z-20 rounded-xl cursor-pointer bg-[#011e44] transition-opacity duration-300"></div>
           {/** Overlay descirption */}
         ...
         <div className=" flex items-center justify-center relative group overflow-hidden col-span-2 row-span-3  rounded-xl">
           {/** Overlay */}
           <div className="absolute inset-0 w-full h-full opacity-0 group-hover:opacity-60 z-20 rounded-xl cursor-pointer bg-[#011e44] transition-opacity duration-300"></div>
           {/** Overlay descirption */}
         ...
         <div className=" flex items-center justify-center relative group overflow-hidden  rounded-xl row-span-10 col-span-3">
           {/** Overlay */}
           <div className="absolute inset-0 w-full h-full opacity-0 group-hover:opacity-60 z-20 rounded-xl cursor-pointer bg-[#011e44] transition-opacity duration-300"></div>
           {/** Overlay descirption */}
