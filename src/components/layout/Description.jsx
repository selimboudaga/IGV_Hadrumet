    ...
    <div className=" w-full flex">
      <div className=" flex flex-col justify-between lg:flex-row w-[85%] xl:w-[77%] mx-auto mt-[150px] lg:mt-[280px] ">
        <div className="flex flex-col lg:w-[61%] ">
          ...
          {/** last year numbers */}
          <div className=" md:w-[90%]   mt-9 flex justify-between">
            <div className=" flex  items-center justify-center ">
              <h1 className=" text-[19px] sm:text-[22px]  xl:text-[31px] font-semibold  text-gray-700 " ref={ref}>
                <Number n={51} isVisible={inView} />
              </h1>
              <h1 className=" ml-1 xl:ml-3 text-center text-gray-700 text-[19px] sm:text-[22px]  xl:text-[31px] font-semibold">
                  Approvals
              </h1>
            </div>
